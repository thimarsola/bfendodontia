<!-- card -->
<article class="content__row__highlights__row__card d-flex ai-center">
    <!-- image -->
    <div class="content__row__highlights__row__card__image">
    ...
    <!-- body -->
    <div class="content__row__highlights__row__card__body">
        <!-- header -->
        <header class="content__row__highlights__row__card__body__header mb-2">
